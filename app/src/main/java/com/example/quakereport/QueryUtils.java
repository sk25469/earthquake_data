...
public final class QueryUtils {
    ...
    public static ArrayList<Earthquake> extractEarthquakes() {
        ...
        try {
            /** create a base JSON object to store the sample response **/
            JSONObject baseJSONobject = new JSONObject(SAMPLE_JSON_RESPONSE);

            /** get the array from the sample response and store it into the variable **/
            JSONArray earthquakeArray = baseJSONobject.getJSONArray("features");

            /** to access all the earthquake array we iterate through the array and extract the properties of each earthquake **/
            for(int i = 0; i < earthquakeArray.length(); i++){
                JSONObject currentEarthquake = earthquakeArray.getJSONObject(i);
                JSONObject properties = currentEarthquake.getJSONObject("properties");

                double earthquakeMagnitude = properties.getDouble("mag");
                String earthquakeLocation = properties.getString("place");
                ...
                Earthquake earthquake = new Earthquake(earthquakeMagnitude, earthquakeLocation, earthquakeTime, url);
